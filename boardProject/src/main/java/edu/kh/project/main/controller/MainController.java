...
public class MainController {
	...
	public int restoreMember(@RequestBody String memNo) {
		return service.restoreMember(memNo);
	}
	
	@ResponseBody
	@PutMapping("deleteMember")
	public int deleteMember(@RequestBody String input) {
		return service.deleteMember(input);
	}
